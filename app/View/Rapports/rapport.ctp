...
<div class="container mainRapport">
    ...
    <h2><?php echo __("1. Entrée de donnée");?></h2>
                    ...
                    <td>
                        <div class="">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">#</div>
					<?php echo $this->Form->input('nbDeLoyer',array('label'=>false,'onkeyup'=>'valueStay(this)','class'=>'toenter form-control','placeholder'=>'Nombre')); ?>
                                </div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">U</div>
                                    	<?php echo $this->Form->input('grandeur',array('label'=>false, 'class'=>'toenter form-control', "empty"=>"Grandeur","options"=>array("1"=>"1 1/2","2"=>"2 1/2","3"=>"3 1/2","4"=>"4 1/2","5"=>"5 1/2","6"=>"6 1/2","7"=>"7 1/2","8"=>"8 1/2","9"=>"9 1/2","10"=>"Autre"))); ?>
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">%</div>
					<?php echo $this->Form->input('pourcRevenus',array('label'=>false,'onkeyup'=>'valueStay(this)','class'=>'maskMoney form-control','readonly'=>'readonly')); ?>
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td>
                        <div class="">
                            <div class="form-group">
                                <div class="input-group">
                                    <div class="input-group-addon">$</div>
					<?php echo $this->Form->input('LtotalRevenu',array('label'=>false,'onkeyup'=>'valueStay(this)','class'=>'maskMoney form-control','readonly'=>'readonly')); ?>
                                </div>
                            </div>
                        </div>
                    </td>
